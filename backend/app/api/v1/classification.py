...
QUESTIONNAIRE_RISK_FACTORS: List[QuestionnaireRiskFactor] = [
    ...
    QuestionnaireRiskFactor(
        ...
        question="Does the system use biometric data to categorise individuals based on sensitive attributes such as race, political opinions, religion, or sexual orientation?",
